...
INSERT INTO SWS_CLASSES(ID, START_TIME, END_TIME, CODE, ID_PROMOTION) VALUES (1, CONCAT(CURDATE(), ' 09:00:00'), CONCAT(CURDATE(), ' 12:00:00'), 1, 1);
INSERT INTO SWS_CLASSES(ID, START_TIME, END_TIME, CODE, ID_PROMOTION) VALUES (2, CONCAT(CURDATE(), ' 14:00:00'), CONCAT(CURDATE(), ' 17:00:00'), 2, 1);
